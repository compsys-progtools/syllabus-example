...
The course is designed around your learning so the grading is based on you demonstrating how much you have learned, but not based on how quickly you learn it. 

Additionally, since we will be studying programming tools, we will use them to administer
the course. To give you a chance to get used to the tools there will be a penalty free zone
...
- responding to 80% of inclass questions (even incorrect answers or `\:idk:` count here)
- reflecting on what you learned and asking a question at the end of class in your experience reflection
...
Details and more ideas are on the [explore](../activities/explore) page of the course website.
...
You can see some ideas as they arise by [issues labeled `community` on the course website repo](https://github.com/introcompsys/fall2023/labels/community).
...
<!-- If you violate a second time, no further work will be graded for the remainder of the semester.  -->
